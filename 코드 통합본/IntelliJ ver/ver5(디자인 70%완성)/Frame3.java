...
public class Frame3 extends JFrame{
    ...
    public Frame3(Frame2 prevPage, String User, Frame3[] pagelist, int order) {
        ...
        lblNewLabel_1.setForeground(new Color(154, 152, 152));
        add(lblNewLabel_1);
        ...
        lblNewLabel_2.setForeground(new Color(154, 152, 152));
        add(lblNewLabel_2);
        ...
        lblNewLabel_3.setForeground(new Color(154, 152, 152));
        add(lblNewLabel_3);
        ...
        RoundedButton2 ttsButton = new RoundedButton2("음성으로 듣기");	//TTS 프로그램 작동시키는 버튼, 기능 구현은 안돼있습니다.
        ...
        RoundedButton2 buyNow = new RoundedButton2("구매하러 가기");		//구매 페이지로 이동시키는 버튼, 이것도 uri값 리턴하는 함수 만들어야 할듯
